...
public class myProductsGroceryOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable2.setSelectionBackground(new java.awt.Color(236, 100, 44));
        ...
        productName4.setFont(new java.awt.Font("Krub", 0, 12)); // NOI18N
        productName4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                productName4ActionPerformed(evt);
            }
        });
        add(productName4, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 380, 110, -1));

        productName5.setFont(new java.awt.Font("Krub", 0, 12)); // NOI18N
        ...
        productName1.setFont(new java.awt.Font("Krub", 0, 12)); // NOI18N
        productName1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                productName1ActionPerformed(evt);
            }
        });
        add(productName1, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 120, 110, -1));

        productPrice.setFont(new java.awt.Font("Krub", 0, 12)); // NOI18N
        ...
        productCategory.setFont(new java.awt.Font("Krub", 0, 12)); // NOI18N
        productCategory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                productCategoryActionPerformed(evt);
            }
        });
        add(productCategory, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 220, 110, -1));
        ...
        add(imageBrowser, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 690, 140, 30));
