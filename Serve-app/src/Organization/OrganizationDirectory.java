...
public class OrganizationDirectory {
    ...
    public Organization createVolunteerOrganization(String name,  Enterprise e, String type) {
        Organization organization = new ConvenienceVolOrganization(name, e, type);
        this.organizationList.add(organization);
        return organization ;
    }    
